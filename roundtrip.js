...
(function (b) {
    b.__adroll = b.__adroll || {
        ...
        cookieEnabled: function (a) {
            if (b.adroll_ext_network || b.adroll_optout || this._broken)return !1;
        ...
        parseUri: function (a) {
            a = /^(?:(?![^:@]+:[^:@\/]*@)([^:\/?#.]+):)?(?:\/\/)?((?:(([^:@]*):?([^:@]*))?@)?([^:\/?#]*)(?::(\d*))?)(((\/(?:[^?#](?![^?#\/]*\.[^?#\/.]+(?:[?#]|$)))*\/?)?([^?#\/]*))(?:\?([^#]*))?(?:#(.*))?)/.exec(a);
            for (var d = {}, c = 14, b = "source protocol authority userInfo user password host port relative path directory file query anchor".split(" "); c--;)d[b[c]] = a[c] ||
            "";
            d.queryKey = {};
        ...
        get_base_url: function (a, d, c, e, f, g) {
            ...
            if (a.length > this._url) {
                this.del(this.__adc);
                if (a.length - j.length > this._url)return "#";
        ...
        get_eids: function () {
            if (b.adroll_ext_network || b.adroll_optout)return "";
            try {
        ...
        check_cookie: function (a, d) {
            if (b.adroll_ext_network || b.adroll_optout)return "";
            for (var c = a.split("|"), e = c.length - 1; 0 <= e; e--)if (c[e]) {
                var f =
                    c[e].split(":");
        ...
        expire_old: function () {
            if (!b.adroll_ext_network && !b.adroll_optout) {
                for (var a = this.get_date(), d = this.get(this.__adc), d = d ? d.split("|") : [""], c = [], e = d.length - 1; 0 <= e; e--)d[e] && d[e].split(":")[1] > a && c.push(d[e]);
        ...
        render_ad_code: function (a, d, c, e) {
            ...
            if ("undefined" === typeof this._r[d] || e) {
                var f = ["width=" + b.adroll_width, "height=" + b.adroll_height,
                    "x=0", "y=0"];
                if (c)this.log("Rendering test ad " + c + " in space " + d), f.push("test_ad=" + c), a = this.get_url(a, d, null, "ad", f); else if (e) {
                ...
                } else this.log("Rendering ad space " + d), a = this.get_url(a, d, null, "ad", f);
                this.expire_old();
        ...
        macro_values: function () {
            ...
            b.adroll_win_notif = "undefined" === typeof b.adroll_win_notif ? null : b.adroll_win_notif;
            var a = {
                r: /^\$\{.*\}$/i,
                g: /^%%.*%%$/i,
                b: /^\[.*\]$/i,
        ...
        addLoadEvent: function (a) {
            if ("undefined" !== typeof b.__adroll_loaded && b.__adroll_loaded || "undefined" !== typeof b._adroll_ie && b._adroll_ie ||
                /msie/i.test(b.navigator.userAgent))return a();
        ...
        get_external_data: function () {
            if ("undefined" !== typeof b.adroll_custom_data) {
                ...
                for (c in a)a.hasOwnProperty(c) && (d[c.toLowerCase()] = a[c]);
                return d
            }
            return null
        },
        ...
        extract_pid: function (a, b, c, e, f, g) {
            ...
            if (!l)return null;
            e || (e = "");
            return {product_id: l, product_group: e, product_action: h ? h.product_action : null}
        },
        get_pid: function (a, d, c, e, f, g) {
            ...
            if (a instanceof Array) {
                f = "?";
                for (g = 0; g < a.length; g++)f += "adroll_product_id=" + this.normalize_var((a[g] + "").toLowerCase(), e), g < a.length - 1 && (f += "&")
            } else f = "?adroll_product_id=" + this.normalize_var((a + "").toLowerCase(), e);
        ...
        get_product_id_from_dom: function (a) {
            ...
            if (d && (d = d.replace(/^\s\s*/, "").replace(/\s\s*$/, ""), a.regular_expression && a.regular_expression_replace))if (c = RegExp(a.regular_expression, "gi"), d = c.exec(d), null !== d) {
                a = a.regular_expression_replace;
                for (c = 0; c < d.length; c++)a = a.replace(RegExp("\\\\" + c, "gi"), d[c] || "");
                d = a
            } else d = "";
            return d
        },
        ...
        external_data_to_qs: function (a) {
            ...
            if (!c)return null;
            for (var e in c)c.hasOwnProperty(e) && d.push(this.normalize_var(b.escape("" + e) + "=" + b.escape("" + c[e])));
            d = d.join("&");
            a && (d = b.escape(d));
        ...
        replace_external_data: function (a) {
            ...
            if (d)for (f in d)d.hasOwnProperty(f) && (e = RegExp("\\[" + f + "\\]", "gi"), a = a.replace(e,
                d[f]), e = RegExp("\\[" + f + "_ESC\\]", "gi"), a = a.replace(e, b.escape(d[f])));
            if (c)for (f in c)c.hasOwnProperty(f) && (e = RegExp("\\[" + f + "\\]", "gi"), a = a.replace(e, c[f]), e = RegExp("\\[" + f + "_ESC\\]", "gi"), a = a.replace(e, b.escape(c[f])));
            return a
        },
        ...
        pixel_loaded: function () {
            this._loaded = !0;
            for (var a = 0; a < b.adroll_callbacks.length; a++)b.adroll_callbacks[a]()
        }
    };
    b.adroll_optout = !1;
    b.adroll_ext_network = null;
