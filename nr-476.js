...
!function (n, e, t) {
    ...
    1: [function (n, e) {
        ...
        function t(n, e, t, o) {
            ...
            var i = m[n][e];
            return i || (m[n][e] = i = {params: t || {}}), i.metrics = r(o, i.metrics), i
        }

        function r(n, e) {
            return e || (e = {count: 0}), e.count += 1, c(n, function (n, t) {
                e[n] = o(t, e[n])
            }), e
        }
        ...
        function u(n) {
            for (var e, t = {}, r = "", o = 0; o < n.length; o++)r = n[o], t[r] = a(m[r]), t[r].length && (e = !0), delete m[r];
            return e ? t : null
        }
        ...
        function f(n, e, r) {
            var o = p[e], i = p[r];
            "undefined" != typeof o && "undefined" != typeof i && t("measures", n, {value: i - o})
        }

        var c = n(1), l = n("handle"), d = n(2), m = {}, p = {};
        e.exports = {store: t, take: u, get: i, mark: s, measure: f}, setTimeout(function () {
            d("bstAgg", function () {
            })
        }, 1e4)
    }, {1: 20, 2: 8, handle: !1}], 3: [function (n, e) {
        function t(n) {
            return s[n]
        }
        ...
        function i(n, e) {
            ...
            return a(n, function (n, i) {
                var u, a, s = [];
                if ("string" == typeof i)u = "&" + n + "=" + r(i), t += u.length, o += u; else if (i.length) {
                    for (t += 9, a = 0; a < i.length && (u = r(f(i[a])), t += u.length, !("undefined" != typeof e && t >= e)); a++)s.push(u);
                    o += "&" + n + "=%5B" + s.join(",") + "%5D"
                }
            }), o
        }
        ...
        e.exports = {obj: i, fromArray: o, qs: r, param: u}
    }, {1: 20, 2: 12}], 4: [function (n, e) {
        function t(n) {
        ...
        function t(n, e) {
            if (n.info.beacon) {
                n.info.queueTime && e.store("measures", "qt", {value: n.info.queueTime}), n.info.applicationTime && e.store("measures", "ap", {value: n.info.applicationTime}), e.measure("be", "starttime", "firstbyte"), e.measure("fe", "firstbyte", "onload"), e.measure("dc", "firstbyte", "domContent");
        ...
        e.exports = {sendBeacon: d(t), sendAll: r, pingErrors: a, sendX: o, on: f, _send: u, _emit: i}
    }, {1: 20, 2: 10, 3: 12, 4: 4, 5: 7, 6: 3}], 6: [function (n) {
        function e(n) {
            m.emit("rates", [n])
        }
        ...
        function t(n, e, t, r, o, i) {
            if (p += 1, d.info.beacon) {
                ...
                u += "?a=" + d.info.applicationID + "&", u += "t=" + n + "&", u += "qt=" + e + "&", u += "ap=" + t + "&", u += "be=" + r + "&", u += "dc=" + o + "&", u += "fe=" + i + "&", u += "c=" + p, f({url: u})
            }
        }
    ...
    }, {1: 9, 2: 1, 3: 4, 4: 8, 5: 11, 6: 2, 7: 5, 8: 10, ee: !1, loader: !1}], 7: [function (n, e) {
        function t(n, e) {
        ...
        function o() {
            for (var n = document.cookie.split(" "), e = 0; e < n.length; e++)if (0 === n[e].indexOf("NREUM=")) {
                for (var t, r, o, a, s = n[e].substring("NREUM=".length).split("&"), f = 0; f < s.length; f++)0 === s[f].indexOf("s=") ? o = s[f].substring(2) : 0 === s[f].indexOf("h=") ? (o = s[f].substring(2), u.store("measures", "ph", {value: 1})) : 0 === s[f].indexOf("p=") ? (r = s[f].substring(2), ";" === r.charAt(r.length - 1) && (r = r.substr(0, r.length - 1))) : 0 === s[f].indexOf("r=") && (t = s[f].substring(2), ";" === t.charAt(t.length - 1) && (t = t.substr(0, t.length - 1)));
                if (t) {
        ...
        e.exports = {navCookie: !0}, t()
    }, {1: 9, 2: 2, loader: !1}], 12: [function (n, e) {
        function t(n) {
            try {
                return o("", {"": n})
            } catch (e) {
            ...
            switch (typeof t) {
                ...
                case"object":
                    ...
                    if ("[object Array]" === Object.prototype.toString.apply(t)) {
                        for (var a = t.length, s = 0; a > s; s += 1)u[s] = o(s, t) || "null";
        ...
        e.exports = function () {
            ...
            function o(t) {
                ...
                for (var o, i, u = /^\s*at (?:((?:\[object object\])?(?:[^(]*\([^)]*\))*[^()]*(?: \[as \S+\])?) )?\(?((?:file|http|https|chrome-extension):.*?)?:(\d+)(?::(\d+))?\)?\s*$/i, a = /^\s*(?:(\S*)(?:\(.*?\))?@)?((?:file|http|https|chrome|safari-extension).*?):(\d+)(?::(\d+))?\s*$/i, s = /^\s*at .+ \(eval at \S+ \((?:(?:file|http|https):[^)]+)?\)(?:, [^:]*:\d+:\d+)?\)$/i, f = /^\s*at Function code \(Function code:\d+:\d+\)\s*/i, c = t.stack.split("\n"), l = [], d = [], m = !1, p = (/^(.*) is undefined$/.exec(t.message), 0), v = c.length; v > p; ++p) {
                    if (o = a.exec(c[p]))i = {
                        ...
                        line: +o[3],
                        column: o[4] ? +o[4] : null
                    }; else if (o = u.exec(c[p]))i = {
                        url: o[2],
                        func: o[1] || null,
                        line: +o[3],
                        column: o[4] ? +o[4] : null
                    }, "Anonymous function" === i.func && (i.func = null); else {
                        if (!s.exec(c[p]) && !f.exec(c[p]) && "anonymous" !== c[p]) {
                            d.push(c[p]);
                            continue
                        }
                        i = {func: "evaluated code"}
                    }
            ...
            function i(t) {
                for (var o, i = t.stacktrace, u = / line (\d+), column (\d+) in (?:<anonymous function: ([^>]+)>|([^\)]+))\(.*\) in (.*):\s*$/i, a = i.split("\n"), s = [], f = [], c = !1, l = 0, d = a.length; d > l; l += 2)if (o = u.exec(a[l])) {
                    var m = {line: +o[1], column: +o[2], func: o[3] || o[4], url: o[5]};
            ...
            function u(o) {
                ...
                for (a in p)t(p, a) && !p[a].src && v.push(p[a]);
                for (a = 2, s = i.length; s > a; a += 2) {
                    var g = null;
                    if (u = f.exec(i[a]))g = {url: u[2], func: u[3], line: +u[1]}; else if (u = c.exec(i[a]))g = {
                        url: u[3],
                        func: u[4]
            ...
            function a(e) {
                ...
                return e.line && (r += ":" + e.line, e.column && (r += ":" + e.column)), {
                    ...
                    message: e.message,
                    stackString: r,
                    frames: [{url: e.sourceURL, line: e.line, column: e.column}]
                }
            }
        ...
        function r(n, e, r) {
            ...
            var g = {stackHash: s(m), exceptionClass: d.name, request_uri: window.location.pathname};
        ...
        function r(n, e, t, r) {
            var o = {n: r, s: e - w.offset, e: t - w.offset, o: "window", t: "timer"};
            c(o)
        }

        function o(n, e, t, r) {
            if (n.type in j)return !1;
            var o = {n: i(n.type), s: t - w.offset, e: r - w.offset, o: u(n.target, e), t: "event"};
            c(o)
        }
        ...
        function u(n, e) {
            ...
            } else n && "string" == typeof n.tagName && (t = n.tagName.toLowerCase(), n.id && (t += "#" + n.id), n.className && (t += "." + k(n.classList).join(".")));
            return "unknown" === t && (e === document ? t = "document" : e === window ? t = "window" : e instanceof FileReader && (t = "FileReader")), t
        }

        function a(n, e, t) {
            var r = {n: "history.pushState", s: t - w.offset, e: t - w.offset, o: n, t: e};
            c(r)
        }

        function s(n) {
            n.forEach(function (n) {
                var e = {n: n.initiatorType, s: 0 | n.fetchStart, e: 0 | n.responseEnd, o: E(n.name), t: n.entryType};
                e.s < C || (C = e.s, c(e))
            })
        }
        ...
        function d() {
            ...
            return 0 === n.length ? {} : (A = {}, {qs: {st: "" + w.offset, ptid: S}, body: {res: n}})
        }
    ...
    }, {1: 8, 2: 5, 3: 2, 4: 11, 5: 20, 6: 14, 7: 21, ee: !1, loader: !1}], 19: [function (n, e) {
        function t(n, e, t) {
        ...
        a.features.xhr && (i.on("jserrors", function () {
            return {body: r.take(["xhr"])}
        }), o("xhr", t), e.exports = t)
    }, {1: 2, 2: 8, 3: 5, 4: 12, loader: !1}], 20: [function (n, e) {
        function t(n, e) {
            var t = [], o = "", i = 0;
